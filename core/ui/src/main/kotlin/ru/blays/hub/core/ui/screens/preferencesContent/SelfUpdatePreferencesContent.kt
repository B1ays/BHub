...
fun SelfUpdateSettingsContent(
    ...
    component: SelfUpdatePreferencesComponent,
) {
            ...
            CollapsingToolbar(
                navigationIcon = {
                    IconButton(
                        onClick = {
                            component.onOutput(
                                SelfUpdatePreferencesComponent.Output.NavigateBack
                            )
                        }
                    ) {
                        Icon(
                ...
                Column(
                    ...
                    SettingsSwitchWithTitle(
                        ...
                        component.sendIntent(
                            SelfUpdatePreferencesComponent.Intent.ChangeCheckUpdates(it)
                        )
                    }
                    VerticalSpacer(4.dp)
                    SettingsRadioButtonWithTitle(
                        title = stringResource(R.string.updatesChannel_stable),
                        selected = updatesChannel == UpdateChannelType.STABLE,
                    ) {
                        component.sendIntent(
                            SelfUpdatePreferencesComponent.Intent.ChangeUpdatesChannel(
                                UpdateChannelType.STABLE
                            )
                        )
                    }
                    VerticalSpacer(4.dp)
                    SettingsRadioButtonWithTitle(
                        ...
                        selected = updatesChannel == UpdateChannelType.BETA
                    ) {
                        component.sendIntent(
                            SelfUpdatePreferencesComponent.Intent.ChangeUpdatesChannel(
                                UpdateChannelType.BETA
                            )
                        )
                    }
                }
