...
fun CatalogsSettingScreen(
    ...
    component: CatalogsPreferencesComponent
) {
    ...
    Scaffold(
            ...
            CollapsingToolbar(
                navigationIcon = {
                    IconButton(
                        onClick = {
                            component.onOutput(
                                 CatalogsPreferencesComponent.Output.NavigateBack
                            )
                        }
                    ) {
                        Icon(
            ...
            FloatingActionButton(
                onClick = {
                    component.sendIntent(
                        CatalogsPreferencesComponent.Intent.AddCatalog
                    )
                },
        ...
        PullToRefreshBox(
            ...
            onRefresh = {
                component.sendIntent(
                    CatalogsPreferencesComponent.Intent.Refresh
                )
            }
        ) {
            if(state.loading) {
                ...
                LazyColumn(
                    ...
                    items(state.catalogs) { catalog ->
                        CatalogItem(
                            ...
                            onClick = {
                                component.sendIntent(
                                    CatalogsPreferencesComponent.Intent.ChangeCatalogEnabled(
                                        catalog = catalog,
                            ...
                            onDelete = {
                                component.sendIntent(
                                    CatalogsPreferencesComponent.Intent.DeleteCatalog(catalog)
                                )
                            }
                        )
                    }
