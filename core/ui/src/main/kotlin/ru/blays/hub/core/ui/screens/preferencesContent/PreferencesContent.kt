...
@Composable
fun SettingsContent(component: PreferencesComponent) {
    Scaffold(
        topBar = {
            CollapsingToolbar(
                actions = {
                    ...
                    DropdownMenu(
                        ...
                        DropdownMenuItem(
                            ...
                            onClick = {
                                component.onOutput(
                                    PreferencesComponent.Output.DeveloperMenu
                                )
                            }
                        )
                    }
        ...
        LazyColumn(
            ...
            item {
                ThemeSetting {
                    component.onOutput(
                        PreferencesComponent.Output.ThemeSettings
                    )
                }
            }
            item {
                CatalogsSetting {
                    component.onOutput(
                        PreferencesComponent.Output.CatalogsSetting
                    )
                }
            }
            item {
                MainSetting {
                    component.onOutput(
                        PreferencesComponent.Output.MainSettings
                    )
                }
            }
            item {
                SelfUpdateSetting {
                    component.onOutput(
                        PreferencesComponent.Output.SelfUpdateSettings
                    )
                }
            }
        }
